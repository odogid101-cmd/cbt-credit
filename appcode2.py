...
def init_db():
    ...
    # Text columns here are flexible to accept structured objects or full data dumps
...
def report_question():
    ...
    q_context = data.get("question_context", "") # Receives user-selected choices and objectives structure layout safely
